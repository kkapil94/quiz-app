        ...
        <Grid id = 'container' container sx={{marginBottom:"2rem"}}>
          <Grid id='ele1' item xs={12} lg={6} md={6} justify="center" >
            ...
            <Typography id='postSub' variant="subtile1"  sx={{fontWeight:'bolder',fontFamily:"montserrat,sans-serif",color:'grey'}}>
              <Typography id='quizText' className='quizText' sx={{padding:'0 4rem'}}>This is an online quiz for  you,to check your knowledge. Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus fuga provident dolore facere laboriosam nobis 
              </Typography>
